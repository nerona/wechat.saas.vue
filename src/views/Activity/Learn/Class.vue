          ...
          area: [
            {
              ...
              school: [
                {
                  name: '五缘湾旗舰校区',
                  location: '厦门市湖里区五缘尊府2号楼201～205',
                  prefix: '0592',
                  tel: '5025315',
                  phone: 'tel:0592-5025315',
                },
              ],
            },
          ],
            ...
            area: [
              ...
              },
              {
                ...
                school: [
                  ...
                  {
                    name: '天天艾学',
                    location: '湖里区五缘西三里源昌鑫海湾140号1101',
                    phone: '13306050790',
                  },
                  {
                    name: '尚学趣',
            ...
            area: [
              {
                ...
                school: [
                  {
                    name: '巨人教育二附小校区',
                    location: '鼓楼区法海路18号帼华大楼B座2层',
                    phone: '15060051473',
                  },
                  {
                    name: '巨人教育屏山校区',
                    location: '鼓楼区屏山小学-博纳小区',
                    phone: '15060051473',
                  },
                  {
                    name: '巨人教育井大校区',
              ...
              },
              {
                ...
                school: [
                  {
                    name: '星礼悦教育（福湾校区）',
                    location: '福州仓山区湾边路916号星礼悦教育福湾校区',
                    phone: '13305021486',
                  },
                  {
                    name: '星礼悦教育（江南名城校区）',
                    location: '福州仓山区江南名城9栋16-18店面',
                    phone: '15860588892',
                  },
                ],
              },
              {
                ...
                school: [
                  {
                    name: '星礼悦教育（台江校区）',
                    location: '福州市台江区鳌祥路水岸华庭39-41号店面星礼悦教育门店',
                    phone: '15205055179',
                  },
                ],
              },
...
.learn-index-class__citys {
  margin: px2vw(16) 4%;
  font-size: px2vw(30);
}
.learn-index-class-citys__name {
  color: #f39800;
  font-size: px2vw(32);
...
.learn-index-class-citys__disname {
  color: #333;
  font-weight: bold;
  margin-top: px2vw(24);
  font-size: px2vw(30);
...
.learn-index-class-citys__school {
  margin-top: px2vw(8);
  text-align: justify;
}
.learn-index-class-citys-school__name {
  color: #595757;
