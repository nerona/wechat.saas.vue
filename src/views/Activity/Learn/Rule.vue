...
<template>
  <div
    id="rule"
    class="learn-index-rule">
    <!-- <div class="learn-index-board__title">
      <span>活动规则</span>
    </div> -->
    <div class="learn-index-board__block1">
    ...
    <div class="learn-index-rule__text">7.名额有限，招满即止。</div>
    <div class="learn-index-rule__text">8.最终解释权归imkid超级课堂。</div>

    <div class="learn-index-board__block2">
      <img src="./../../../assets/activity/learn/img_3.png">
    </div>
    <!-- <div class="learn-index-board__title">
      <span>客服热线</span>
    </div>
    <div class="learn-index-rule__call">
      <a :href="callPhone">{{ phone }}</a>
    </div> -->
  </div>
</template>
<style lang="less">
...
.learn-index-rule__text {
  padding: 0 px2vw(50);
  letter-spacing: px2vw(2);
}
.learn-index-rule__call {
  text-align: center;
  margin-top: px2vw(4);
...
.learn-index-board__block2{
  width: 90%;
  margin-left: 10%;
  position: relative;
  top: px2vw(-60);
}
.learn-index-board__block2 img{
  width: 100%;
}
</style>
